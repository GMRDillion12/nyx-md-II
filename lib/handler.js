    ...
    try {
        ...
        if (menuMatch) {
            ...
            const SUBMENUS = {
                ...
                3: { label: "ANIME MENU", folders: ["animesfw"], category: "animesfw" },
