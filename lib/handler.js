    ...
    try {
        ...
        if (menuMatch) {
            ...
            const SUBMENUS = {
                ...
                // For anime menu we support a two-step text flow: ".3" lists the SFW category,
                // ".3 1" shows its commands.
                3: { label: "ANIME MENU", folders: ["2DArt"], category: "animesfw" },
            ...
            if (submenu) {
                ...
                // (e.g. ".3 1"), show only that folder's commands.
                let menuText;
                if (num === 3 && extra) {
                    const map = { '1': '2DArt' };
                    ...
                    if (folder) {
                        ...
                        menuText = `Invalid selection. Reply with ${prefix}3 1 to choose the anime category.`;
                    }
                } else {
