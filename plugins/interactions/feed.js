...
module.exports = {
    ...
    async execute(sock, m, args, config) {
        try {
            ...
            const { buffer, mimetype } = await fetchGif('feed');
            const caption = `🍽️ *${m.pushName || "Someone"}* fed *@${target.split("@")[0]}*`;
            ...
            await sock.sendMessage(m.chat, { text: "❌ Failed to feed." }, { quoted: m });
        }
    }
};