...
module.exports = {
    command: ["pussylick"],
    category: "nsfwgif",
    description: "Get a random NSFW pussylick GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading pussylick GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/pussylick/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random pussylick GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("PussylickGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch pussylick GIF. Try again later! (No GIF available this time?)";
