...
module.exports = {
    ...
    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading fuck GIF..." });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random fuck GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("FuckGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch fuck GIF. Try again later! (No GIF available this time?)";
