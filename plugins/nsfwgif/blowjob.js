...
module.exports = {
    ...
    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading blowjob GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/blowjob/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random blowjob GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("BlowjobGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch blowjob GIF. Try again later! (No GIF available this time?)";
