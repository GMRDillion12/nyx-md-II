...
module.exports = {
    command: ["cumg"],
    category: "nsfwgif",
    description: "Get a random NSFW cum GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading cum GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/cum/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random cum GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("CumGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch cum GIF. Try again later! (No GIF available this time?)";
