...
module.exports = {
    command: ["solom"],
    category: "nsfwgif",
    description: "Get a random NSFW solo (M) GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading solo (M) GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/solo_male/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random solo (M) GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("SoloGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch solo (M) GIF. Try again later! (No GIF available this time?)";
