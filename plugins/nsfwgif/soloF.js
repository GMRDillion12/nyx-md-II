...
module.exports = {
    command: ["solof"],
    category: "nsfwgif",
    description: "Get a random NSFW solo (F) GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading solo (F) GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/solo/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random solo (F) GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            let replyText = "❌ Failed to fetch solo (F) GIF. Try again later! (No GIF available this time?)";
