...
module.exports = {
    command: ["yurig"],
    category: "nsfwgif",
    description: "Get a random NSFW yuri GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading yuri (Lesbian) GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/yuri/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random yuri GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("YuriGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch yuri GIF. Try again later! (No GIF available this time?)";
