...
module.exports = {
    command: ["yaoig"],
    category: "nsfwgif",
    description: "Get a random NSFW yaoi GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading yaoi (Gay) GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/yaoi/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random yaoi GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("YaoiGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch yaoi GIF. Try again later! (No GIF available this time?)";
