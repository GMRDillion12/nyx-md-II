...
module.exports = {
    command: ["mmf"],
    category: "nsfwgif",
    description: "Get a random NSFW threesome (MMF) GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading threesome (MMF) GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/threesome_mmf/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random threesome (MMF) GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("ThreesomeMMF GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch threesome (MMF) GIF. Try again later! (No GIF available this time?)";
