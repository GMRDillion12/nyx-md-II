...
module.exports = {
    command: ["mff"],
    category: "nsfwgif",
    description: "Get a random NSFW threesome (MFF) GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading threesome (MFF) GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/threesome_ffm/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random threesome (MFF) GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("ThreesomeMFF GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch threesome (MFF) GIF. Try again later! (No GIF available this time?)";
