...
module.exports = {
    command: ["nekog"],
    category: "nsfwgif",
    description: "Get a random NSFW neko GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🔞 Loading neko GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/nsfw/neko/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "🔞 Here's your random neko GIF! Enjoy the animation 💦😏",
            }, { quoted: m });
            ...
            console.error("NekoGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch neko GIF. Try again later! (No GIF available this time?)";
