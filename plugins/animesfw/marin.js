...
module.exports = {
    command: ["smarin"],
    category: "animesfw",
    description: "Get a random SFW marin-kitagawa image",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🩷 Loading your marin-kitagawa..." });

            const response = await axios.get("https://api.waifu.im/images", {
                params: {
                    includedTags: "marin-kitagawa",
                    isNsfw: false,
                },
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                image: buffer,
                caption: "🩷 Here's your random marin-kitagawa! Enjoy 💕",
            }, { quoted: m });
