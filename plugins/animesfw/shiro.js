...
module.exports = {
    ...
    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "🩷 Loading shiro image..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/shiro/img", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                image: { url: imgUrl },
                caption: "🩷 Here's your random shiro! Enjoy 💕",
            }, { quoted: m });
