...
module.exports = {
    command: ["crygif"],
    category: "sfwgif",
    description: "Get a random SFW cry GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading cry GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/cry/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random cry GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Cry GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch cry GIF. Try again later! (No GIF available this time?)";
