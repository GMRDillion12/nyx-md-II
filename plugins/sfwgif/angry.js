...
module.exports = {
    command: ["angrygif"],
    category: "sfwgif",
    description: "Get a random SFW angry GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "😡 Loading angry GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/angry/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: " Here's your random angry GIF! Enjoy the animation 😠😤",
            }, { quoted: m });
            ...
            console.error("AngryGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch angry GIF. Try again later! (No GIF available this time?)";
