...
module.exports = {
    command: ["kissgif"],
    category: "sfwgif",
    description: "Get a random SFW kiss GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading kiss GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/kiss/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random kiss GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Kiss GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch kiss GIF. Try again later! (No GIF available this time?)";
