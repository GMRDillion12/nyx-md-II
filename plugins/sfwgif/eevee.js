...
module.exports = {
    command: ["eeveegif"],
    category: "sfwgif",
    description: "Get a random SFW eevee GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading eevee GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/eevee/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's eevee GIF! Enjoy the animation 😊",
            }, { quoted: m });
            ...
            console.error("Eevee GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch eevee GIF. Try again later! (No GIF available this time?)";
