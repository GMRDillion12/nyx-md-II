...
module.exports = {
    ...
    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading bite GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/bite/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random bite GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("BiteGIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch bite GIF. Try again later! (No GIF available this time?)";
