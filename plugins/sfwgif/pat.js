...
module.exports = {
    command: ["patgif"],
    category: "sfwgif",
    description: "Get a random SFW pat GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading pat GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/pat/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random pat GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Pat GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch pat GIF. Try again later! (No GIF available this time?)";
