...
module.exports = {
    command: ["dancegif"],
    category: "sfwgif",
    description: "Get a random SFW dance GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading dance GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/dance/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random dance GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Dance GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch dance GIF. Try again later! (No GIF available this time?)";
