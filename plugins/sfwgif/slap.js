...
module.exports = {
    command: ["slapgif"],
    category: "sfwgif",
    description: "Get a random SFW slap GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading slap GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/slap/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random slap GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Slap GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch slap GIF. Try again later! (No GIF available this time?)";
