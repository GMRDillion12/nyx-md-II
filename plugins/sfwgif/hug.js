...
module.exports = {
    ...
    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading hug GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/hug/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random hug GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Hug GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch hug GIF. Try again later! (No GIF available this time?)";
