...
module.exports = {
    command: ["cuddlegif"],
    category: "sfwgif",
    description: "Get a random SFW cuddle GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading cuddle GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/cuddle/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random cuddle GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Cuddle GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch cuddle GIF. Try again later! (No GIF available this time?)";
