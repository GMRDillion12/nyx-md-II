...
module.exports = {
    command: ["ticklegif"],
    category: "sfwgif",
    description: "Get a random SFW tickle GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading tickle GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/tickle/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random Tickled GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Tickle GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch tickle GIF. Try again later! (No GIF available this time?)";
