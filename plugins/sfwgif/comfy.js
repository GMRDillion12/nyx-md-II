...
module.exports = {
    command: ["comfygif"],
    category: "sfwgif",
    description: "Get a random SFW comfy GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading comfy GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/comfy/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random comfy GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Comfy GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch comfy GIF. Try again later! (No GIF available this time?)";
