...
module.exports = {
    ...
    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading fluff GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/fluff/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random fluff GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Fluff GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch fluff GIF. Try again later! (No GIF available this time?)";
