...
module.exports = {
    command: ["smilegif"],
    category: "sfwgif",
    description: "Get a random SFW smile GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading smile GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/smile/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random Smile GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Smile GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch smile GIF. Try again later! (No GIF available this time?)";
