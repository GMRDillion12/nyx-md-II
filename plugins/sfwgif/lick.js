...
module.exports = {
    command: ["lickgif"],
    category: "sfwgif",
    description: "Get a random SFW lick GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading lick GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/lick/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random lick GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Lick GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch lick GIF. Try again later! (No GIF available this time?)";
