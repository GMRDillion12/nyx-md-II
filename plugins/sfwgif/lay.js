...
module.exports = {
    command: ["laygif"],
    category: "sfwgif",
    description: "Get a random SFW lay GIF",

    execute: async (sock, m) => {
        try {
            await sock.sendMessage(m.chat, { text: "Loading lay GIF..." });

            const response = await axios.get("https://api.purrbot.site/v2/img/sfw/lay/gif", {
                timeout: 10000,
            });
            ...
            await sock.sendMessage(m.chat, {
                ...
                gifPlayback: true,
                mimetype: "video/mp4",
                caption: "Here's your random lay GIF! Enjoy the animation",
            }, { quoted: m });
            ...
            console.error("Lay GIF command error:", err.message || err);

            let replyText = "❌ Failed to fetch lay GIF. Try again later! (No GIF available this time?)";
